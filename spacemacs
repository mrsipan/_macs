  ...
  (setq-default
   ...
   '(
     ...
     (org :variables
          ...
          org-journal-dir "~/gdrive/mrsipan/org/journal"
          org-journal-file-format "mrsipan-%Y"
...
values."
  ...
  (setq-default
   ...
   ;; dotspacemacs-themes '(default spacemacs-dark wombat)
   ;; dotspacemacs-themes '(wombat graham)
